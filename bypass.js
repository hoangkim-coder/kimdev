...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Usage: node kim [host] [time] [rps] [thread] [proxyfile]`); process.exit();}
...
const RESTART_DELAY = 1000;
 ...
 console.clear();
    ...
    console.log(`--------------------------------------------`.gray);
    console.log(`Kim Stresser`.brightCyan);
